...
const Header = () => {
  ...
  const navLinks = mainSiteNavLinks; // Header only shows main site links
        ...
        >
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className={cn(
                "text-header-foreground hover:bg-primary/80 hover:text-white group data-[state=open]:bg-primary data-[state=open]:text-primary-foreground",
          ...
          <DropdownMenuContent
            className="bg-popover" // Should now use header-background due to CSS var override
            onMouseEnter={() => handleMouseEnter(link.label, isMobileLink)}
            onMouseLeave={() => handleMouseLeave(isMobileLink)}
          >
