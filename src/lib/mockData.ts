...
const earn2TradeAccountTiers: AccountTier[] = [
...
const e8MarketsAccountTiers: AccountTier[] = [
    // E8 One (1-Step)
...
export const mockPropFirms: PropFirm[] = [
  {
    ...
    slug: 'e8-markets',
    name: 'E8 Markets',
    logoUrl: '/images/e8markets-logo.png',
    websiteUrl: '#',
    affiliateLink: '#',
    isFeatured: false,
    ceo: 'Dylan Elchami',
