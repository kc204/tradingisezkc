...
export const mockPropFirms: PropFirm[] = [
  ...
  },
  {
    ...
    websiteUrl: '#',
    affiliateLink: '#',
    briefDescription: 'Innovative Forex & CFD prop firm with a focus on modern platforms and trader education.',
    fullReview: 'Tradify aims to provide a seamless funding experience for Forex and CFD traders. They emphasize transparency in their rules and offer access to popular trading platforms. Their educational resources are a plus for developing traders. Payouts are processed bi-weekly upon request.',
    pros: ['Clear challenge rules', 'Good selection of tradable assets', 'Educational content available'],
    cons: ['Newer firm in the market', 'Maximum leverage might be lower than some competitors'],
    keyFeatures: ['1-Step and 2-Step challenges', 'TradingView and MT4/MT5 support', 'Bi-weekly payouts'],
    keyInfoSnippets: [
      { label: 'Profit Split', value: 'Up to 85%' },
      { label: 'Challenge Style', value: '1-Step / 2-Step' },
      { label: 'Max Leverage', value: '1:100 (Forex)'}
    ],
    offerBadgeLabel: 'Modern Trading',
    fundingModels: ['1-Step Challenge', '2-Step Challenge'],
    profitSplit: '75% - 85%',
    drawdownRules: '5% Daily, 10% Overall (Typical)',
    profitTarget: '8% Phase 1, 5% Phase 2 (2-Step)',
    tradableInstruments: ['Forex', 'Indices', 'Commodities', 'Crypto CFDs'],
    platforms: ['MetaTrader 4 (MT4)', 'MetaTrader 5 (MT5)', 'TradingView'],
    rating: 4.3,
    isFeatured: true, 
