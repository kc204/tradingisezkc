...
export const metadata = {
  title: 'Affiliate Disclosure | Prop Firm Finder',
  description: 'Read the Affiliate Disclosure for Prop Firm Finder.',
};
    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>At Prop Firm Finder, our mission is to provide traders with valuable, unbiased information and resources to help them succeed. To support our work and keep our content free, we participate in affiliate marketing programs.</p>
          ...
          <p>Using our affiliate links to make purchases helps support Prop Firm Finder, allowing us to continue creating high-quality content, maintaining the website, and expanding our resources. The price you pay for any product or service is the same whether you use our affiliate link or go directly to the vendor's website.</p>
          ...
          <p>By using our affiliate links, you are supporting Prop Firm Finder, and we genuinely appreciate it. This support enables us to continue our mission of empowering traders.</p>
