            ...
            <div ref={scrollContainerRef} className="overflow-x-auto">
                <table className="min-w-full text-[11px] sm:text-xs">
                    <thead className="sticky top-0 z-20 bg-black/50 backdrop-blur-lg border-b border-white/10">
                        <tr>
                            {columns.map(col => (
                                <th key={col.key} scope="col" className={cn(`px-2 py-3 sm:px-4 text-${col.align} font-bold text-gray-400 uppercase tracking-wider whitespace-nowrap`, col.sticky ? `sticky z-10 ${col.sticky === 'left' ? 'left-0 bg-black/50 backdrop-blur-lg' : 'right-0 bg-gray-900'}` : 'bg-gray-800/95', col.className)}>
...
export default function CryptoPage() {
  ...
  return (
    <div className="space-y-16">
       <div className="relative w-full overflow-hidden bg-background flex flex-col items-center justify-center rounded-lg py-12 md:py-24">
        ...
        <div className="mt-8 relative z-20">
          <StarBorder<typeof Link>
            as={Link}
            href="/crypto/compare-prop-firms"
          >
