...
const allSentimentFirms: FirmData[] = mockPropFirms.map(firm => ({
  name: firm.name,
  logoUrl: firm.logoUrl,
}));

const firmColors = allSentimentFirms.reduce((acc, firm) => {
        ...
        <div className="space-y-12 font-sans text-white">
            <main>
                ...
                <section>
                    ...
                    {allSentimentFirms.filter(firm => selectedFirms.includes(firm.name)).map(firm => (
...
export default function Home() {
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="py-12">
        <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold text-foreground tracking-tight mb-2">Prop Firm Sentiment Trends</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">Tracking community sentiment for top prop firms over the last 4 weeks.</p>
            
            {isClient && <SentimentAnalyzerSection />}
