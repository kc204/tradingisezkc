        ...
        <div className="space-y-4 mb-6">
            <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                <div className="flex items-center gap-4 flex-wrap">
                    <div className="flex items-center p-1 bg-card rounded-full">
                     ...
                     <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {sizes.map(size => (
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-300 ${filters.accountSize.includes(size) ? 'bg-primary text-primary-foreground shadow-lg shadow-primary/30' : 'bg-muted text-muted-foreground hover:bg-muted/80'}`}
                            >
                     ...
                     <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {stepsOptions.map(step => (
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-300 ${filters.steps.includes(step) ? 'bg-primary text-primary-foreground shadow-lg shadow-primary/30' : 'bg-muted text-muted-foreground hover:bg-muted/80'}`}
                            >
                ...
                <div className="relative flex-grow w-full md:flex-grow-0 md:w-auto">
                    ...
                    <input type="text" placeholder="Search firms..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full md:w-64 bg-card border border-border rounded-full h-11 pl-12 pr-4 text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring" />
                </div>
            </div>
        ...
        <tr className="group hover:bg-muted/50 transition-colors duration-200">
            ...
            <td className="px-4 py-3 whitespace-nowrap sticky right-0 z-0 bg-card/80 backdrop-blur-sm group-hover:bg-muted/80">
                <div className="flex items-center gap-3">
                    ...
                    <Button asChild>
                      <a href={challenge.affiliateLink} target="_blank" rel="noopener noreferrer">
                        Buy
                      </a>
                    </Button>
                </div>
