...
export const metadata = {
  title: 'Terms of Service | TradingisEZ',
  description: 'Read the Terms of Service for TradingisEZ.',
};
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>attempt to decompile or reverse engineer any software contained on TradingisEZ's Website;</li>
          ...
          <p>The materials on TradingisEZ's Website are provided on an 'as is' basis. TradingisEZ makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</p>
          <p>Further, TradingisEZ does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Website or otherwise relating to such materials or on any sites linked to this site. Trading involves substantial risk of loss and is not suitable for all investors. Past performance is not necessarily indicative of future results.</p>

          <h3 className="text-xl font-semibold mt-6 mb-2">Limitations</h3>
          <p>In no event shall TradingisEZ or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on TradingisEZ's Website, even if TradingisEZ or a TradingisEZ authorized representative has been notified orally or in writing of the possibility of such damage.</p>
          ...
          <p>TradingisEZ reserves the right to revise these Terms at any time without notice. By using this Website you are agreeing to be bound by the then current version of these Terms.</p>
